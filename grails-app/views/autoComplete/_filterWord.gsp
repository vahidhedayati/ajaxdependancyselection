 ...
 <input type="text" name="triggerWord" value="${params.triggerWord }"  onClick="this.value='';${params.id}resetValue(this)" onChange="${params.id}AppendValue(this)" >

<script>
function ${params.id}resetValue() { 
